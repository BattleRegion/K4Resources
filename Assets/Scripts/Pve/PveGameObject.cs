...
//所有对象的基类用于定位
public class PveGameObject : MonoBehaviour
{
    #region 属性
    ...
    public PvpGameControl GameControl_pvp;
    public PveGameControl GameControl;
    
    public string WarStyle = "pve";
    #endregion
    ...
    //pvp control  
    public PvpGameControl GameControlFun(int k)
    {
        if (GameControl_pvp != null)
        {
            return GameControl_pvp;
        }
        return null;
    }
    //pve control
    public PveGameControl GameControlFun()
    {
        if (GameControl != null)
        {
            return GameControl;
    ...
    public virtual void CleanZorder(GameObject render)
    {
    ...
    public DungeonEnum.FaceDirection GetTargetDirection(PveGameObject target)
    {
    ...
    public float Distance(PveGameObject from, PveGameObject to)
    {
